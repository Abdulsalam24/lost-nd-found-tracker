  ...
  if (!user) {
    return (
      <div className="card p-6 text-center">
        <p className="text-sm text-text-muted">Log in to claim or contact the reporter.</p>
        <a
    ...
    <>
      <div className="card p-6 space-y-3">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-border-light bg-bg-elevated px-4 py-2.5 text-sm font-medium text-text transition-colors hover:bg-bg-hover"
          ...
          {reporterPhone && (
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-2.5 text-sm font-medium text-emerald-400 transition-colors hover:bg-emerald-500/20"
            >
    ...
    <div className="space-y-4">
      ...
      <div className="card p-5">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-semibold text-text">Your Report</span>
        </div>
        <Link
          href={`/chat?item=${itemId}`}
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-border-light bg-bg-elevated px-4 py-2.5 text-sm font-medium text-text transition-colors hover:bg-bg-hover"
        >
          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
          </svg>
              ...
              <div key={claim.id} className="rounded-xl border-2 border-yellow-500/20 bg-yellow-500/5 p-4">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-text">{claim.claimant?.name ?? "_"}</span>
                  </div>
